		...
		<div id="box2-wrapper">	
			<div id="box2">
				<div class="box2">
					<h1>1860</h1>
					<h2>единиц</h2>
					<h3>Произведенной продукции</h3>
				</div>
				<div class="box2">
					<h1>780</h1>
					<h2>Спроектированных</h2>
					<h3>объектов</h3>
				</div>
				<div class="box2">
					<h1>140</h1>
					<h2>объектов</h2>
					<h3>На постоянном сервисном обслуживании</h3>
				</div>
				<div class="box2">
					<h1>3</h1>
					<h2>Завода</h2>
					<h3>Работающих<br>24 часа в сутки</h3>
				</div>
				<div class="clear"></div>
			</div>
		</div>
	...
	============================================= -->
		...
		<div id="box3-wrapper">	
			<div id="box3">
				...
				<div class="box3">
					<h1>Казахстан</h1>
					<h2><a href="mailto:chupakhin@sk-rosprom.ru">chupakhin@sk-rosprom.ru</a><br>+7 778 100 59 78</h2>					
				</div>				
				<!--<div class="box3">
