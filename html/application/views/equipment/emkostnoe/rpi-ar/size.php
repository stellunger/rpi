<div id="content">
					...
					<div id="opros-list-button"><a href="<? echo base_url(); ?>ol/RPI-AR.docx"><img src="<?php echo base_url(); ?>images/d4.png" alt="">
					<span>Заполнить опросный лист</span></a></div>
					<div class="clear"></div>

					<br>
									
					<center><img src="<?php echo base_url(); ?>images/products/reservuary-size.png" /></center>
				</div>
				<div class="clear"></div>
			</div>
		</div>			